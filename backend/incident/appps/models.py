...
class Employee(models.Model):
    ...
    phone = models.BigIntegerField(validators=[MinValueValidator(1000000000), MaxValueValidator(9999999999)], null=True)
...
class Incident(models.Model):
    ...
    customIncidentId = models.CharField(max_length=1000, null=True)
    customer = models.ForeignKey(Customer, on_delete=models.PROTECT, null=True, blank=True)
    employee = models.ForeignKey(Employee, on_delete=models.PROTECT, null=True, blank=True)
    incidentDescription = models.TextField(max_length=1000, null=True)
    incidentRemark = models.TextField(max_length=1000, null=True)
